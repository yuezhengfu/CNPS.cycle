#' ARS.SO3.H2S abundance information was extracted and combined at different species taxonomic levels
...
##' data(tax)
##' data(abundance)
#' ARS.SO3.H2S <- ARS.SO3.H2S(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group)
#' @author contact: Zhengfu Yue \email{yuezhengfu2011@163.com} Liang Zeng \email{zengliang@biozeron.com}
#' @export


ARS.SO3.H2S <- function(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group){
    d <- c("K00380","K00381","K00392")
