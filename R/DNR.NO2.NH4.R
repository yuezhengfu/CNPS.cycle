#' DNR.NO2.NH4 abundance information was extracted and combined at different species taxonomic levels
...
##' data(tax)
##' data(abundance)
#' DNR.NO2.NH4 <- DNR.NO2.NH4(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group)
#' @author contact: Zhengfu Yue \email{yuezhengfu2011@163.com}
#' @export

DNR.NO2.NH4 <- function(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group){
    d <- c("K00362","K00363","K03385","K15876")
