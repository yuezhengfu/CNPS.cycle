#' Nitrification.NH2OH.NH4 abundance information was extracted and combined at different species taxonomic levels
...
##' data(tax)
##' data(abundance)
#' Nitrification.NH2OH.NH4 <- Nitrification.NH2OH.NH4(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group)
#' @author contact: Zhengfu Yue \email{yuezhengfu2011@163.com}
#' @export

Nitrification.NH2OH.NH4 <- function(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group){
    d <- c("K05601","K15864")
