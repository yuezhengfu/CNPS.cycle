#' SOX abundance information was extracted and combined at different species taxonomic levels
...
##' data(tax)
##' data(abundance)
#' SOX <- SOX(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group)
#' @author contact: Zhengfu Yue \email{yuezhengfu2011@163.com}
#' @export


SOX <- function(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group){
    d <- c("K17722","K17723","K17724","K17725","K17726","K17727")
