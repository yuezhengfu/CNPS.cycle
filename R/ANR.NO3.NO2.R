#' ANR.NO3.NO2 abundance information was extracted and combined at different species taxonomic levels
...
##' data(tax)
##' data(abundance)
#' ANR.NO3.NO2 <- ANR.NO3.NO2(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group)
#' @author contact: Zhengfu Yue \email{yuezhengfu2011@163.com} Liang Zeng \email{zengliang@biozeron.com}
#' @export


ANR.NO3.NO2 <- function(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group){
    d <- c("K00367","K00372")
