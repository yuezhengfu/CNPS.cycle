#' NF.N2.NH4 abundance information was extracted and combined at different species taxonomic levels
...
##' data(abundance)
#'
#' NF.N2.NH4 <- NF.N2.NH4(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group)
#'
#' @author contact: Zhengfu Yue \email{yuezhengfu2011@163.com} Liang Zeng \email{zengliang@biozeron.com}
#' @export

NF.N2.NH4 <- function(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group){
    d <- c("K02588","K02586","K02591")
