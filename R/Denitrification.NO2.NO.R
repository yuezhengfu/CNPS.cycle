#' Denitrification.NO2.NO abundance information was extracted and combined at different species taxonomic levels
...
##' data(abundance)
#'
#' Denitrification.NO2.NO <- Denitrification.NO2.NO(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group)
#'
...
Denitrification.NO2.NO <- function(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group){
    d <- c("K00368","K15864")
