#' Nitrification.NH4.NH2OH abundance information was extracted and combined at different species taxonomic levels
...
##' data(abundance)
#'
#' Nitrification.NH4.NH2OH <- Nitrification.NH4.NH2OH(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group)
#'
#' @author contact: Zhengfu Yue \email{yuezhengfu2011@163.com} Liang Zeng \email{zengliang@biozeron.com}
#' @export

Nitrification.NH4.NH2OH <- function(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group){
    d <- c("K10944","K10945","K10946")
