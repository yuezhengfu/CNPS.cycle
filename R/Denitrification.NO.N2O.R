#' Denitrification.NO.N2O abundance information was extracted and combined at different species taxonomic levels
...
##' data(tax)
##' data(abundance)
#' Denitrification.NO.N2O <- Denitrification.NO.N2O(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group)
#' @author contact: Zhengfu Yue \email{yuezhengfu2011@163.com}
#' @export

Denitrification.NO.N2O <- function(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group){
    d <- c("K04561","K02305")
