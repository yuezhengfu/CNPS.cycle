#' SM abundance information was extracted and combined at different species taxonomic levels
...
##' data(abundance)
#'
#' SM <- SM(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group)
#'
#' @author contact: Zhengfu Yue \email{yuezhengfu2011@163.com} Liang Zeng \email{zengliang@biozeron.com}
#' @export


SM <- function(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group){
    d <- c("K11180","K11181","K04091","K00299","K17728","K16968","K16969","K15762",
