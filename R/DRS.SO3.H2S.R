#' DRS.SO3.H2S abundance information was extracted and combined at different species taxonomic levels
...
##' data(tax)
##' data(abundance)
#' DRS.SO3.H2S <- DRS.SO3.H2S(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group)
#' @author contact: Zhengfu Yue \email{yuezhengfu2011@163.com}
#' @export

DRS.SO3.H2S <- function(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group){
    d <- c("K11180","K11181")
