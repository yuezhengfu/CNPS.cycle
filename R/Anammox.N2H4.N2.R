#' Anammox.N2H4.N2 abundance information was extracted and combined at different species taxonomic levels
...
##' data(tax)
##' data(abundance)
#' Anammox.N2H4.N2 <- Anammox.N2H4.N2(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group)
...
Anammox.N2H4.N2 <- function(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group){
    A <- as.data.frame(Gene$K20935)
    A[A == ""] <- NA
