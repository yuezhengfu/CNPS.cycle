#' AR abundance information was extracted and combined at different species taxonomic levels
...
##' data(tax)
##' data(abundance)
#' AR <- AR(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group)
#' @author contact: Zhengfu Yue \email{yuezhengfu2011@163.com} Liang Zeng \email{zengliang@biozeron.com}
#' @export


AR <- function(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group){
    d <- c("K02256","K02262","K02274","K02276")
