#' Anammox.NH4.N2H4 abundance information was extracted and combined at different species taxonomic levels
...
##' data(tax)
##' data(abundance)
#' Anammox.NH4.N2H4 <- Anammox.NH4.N2H4(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group)
#' @author contact: Zhengfu Yue \email{yuezhengfu2011@163.com}
#' @export


Anammox.NH4.N2H4 <- function(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group){
    d <- c("K20932","K20933","K20934")
