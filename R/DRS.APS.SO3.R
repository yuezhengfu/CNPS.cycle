#' DRS.APS.SO3 abundance information was extracted and combined at different species taxonomic levels
...
##' data(tax)
##' data(abundance)
#' DRS.APS.SO3 <- DRS.APS.SO3(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group)
#' @author contact: Zhengfu Yue \email{yuezhengfu2011@163.com} Liang Zeng \email{zengliang@biozeron.com}
#' @export


DRS.APS.SO3 <- function(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group){
    d <- c("K00394","K00395")
