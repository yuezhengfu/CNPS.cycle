#' NA.NH4.ON abundance information was extracted and combined at different species taxonomic levels
...
##' data(abundance)
#'
#' NA.NH4.ON <- NA.NH4.ON(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group)
#'
#' @author contact: Zhengfu Yue \email{yuezhengfu2011@163.com} Liang Zeng \email{zengliang@biozeron.com}
#' @export


NA.NH4.ON <- function(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group){
    d <- c("K01915","K00265","K00266","K00264","K00284")
