#' DRS.SO4.APS abundance information was extracted and combined at different species taxonomic levels
...
##' data(abundance)
#'
#' DRS.SO4.APS <- DRS.SO4.APS(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group)
#'
#' @author contact: Zhengfu Yue \email{yuezhengfu2011@163.com} Liang Zeng \email{zengliang@biozeron.com}
#' @export


DRS.SO4.APS <- function(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group){
    d <- c("K00958","K00988")
