#' SU.SO4 abundance information was extracted and combined at different species taxonomic levels
...
##' data(tax)
##' data(abundance)
#' SU.SO4 <- SU.SO4(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group)
#' @author contact: Zhengfu Yue \email{yuezhengfu2011@163.com}
#' @export


SU.SO4 <- function(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group){
    d <- c("K02045","K02046","K02047","K02048")
