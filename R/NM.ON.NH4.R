#' NM.ON.NH4 abundance information was extracted and combined at different species taxonomic levels
...
##' data(tax)
##' data(abundance)
#' NM.ON.NH4 <- NM.ON.NH4(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group)
#' @author contact: Zhengfu Yue \email{yuezhengfu2011@163.com}
#' @export

NM.ON.NH4 <- function(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group){
    d <- c("K00260","K15371","K00261","K00262","K01455","K01501","K01725","K00926","K00549")
