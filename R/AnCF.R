#' AnCF abundance information was extracted and combined at different species taxonomic levels
...
##' data(tax)
##' data(abundance)
#' AnCF <- AnCF(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group)
#' @author contact: Zhengfu Yue \email{yuezhengfu2011@163.com}
#' @export


AnCF <- function(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group){
    d <- c("K00174","K00175","K00244","K01648","K00194","K00197")
