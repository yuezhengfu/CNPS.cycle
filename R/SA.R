#' SA abundance information was extracted and combined at different species taxonomic levels
...
##' data(tax)
##' data(abundance)
#' SA <- SA(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group)
#' @author contact: Zhengfu Yue \email{yuezhengfu2011@163.com}
#' @export


SA <- function(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group){
    d <- c("K01739","K10764","K01738")
