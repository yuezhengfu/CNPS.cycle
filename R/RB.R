#' RB abundance information was extracted and combined at different species taxonomic levels
...
##' data(tax)
##' data(abundance)
#' RB <- RB(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group)
#' @author contact: Zhengfu Yue \email{yuezhengfu2011@163.com}
#' @export


RB <- function(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group){
    d <- c("K07636","K07657","K07658")
