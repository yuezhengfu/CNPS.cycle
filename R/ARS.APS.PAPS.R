#' ARS.APS.PAPS abundance information was extracted and combined at different species taxonomic levels
...
##' data(tax)
##' data(abundance)
#' ARS.APS.PAPS <- ARS.APS.PAPS(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group)
#' @author contact: Zhengfu Yue \email{yuezhengfu2011@163.com}
#' @export



ARS.APS.PAPS <- function(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group){
    d <- c("K00955","K00860")
