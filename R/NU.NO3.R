#' NU.NO3 abundance information was extracted and combined at different species taxonomic levels
...
##' data(abundance)
#'
#' NU.NO3 <- NU.NO3(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group)
#'
#' @author contact: Zhengfu Yue \email{yuezhengfu2011@163.com} Liang Zeng \email{zengliang@biozeron.com}
#' @export

NU.NO3 <- function(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group){
