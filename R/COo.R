#' COo abundance information was extracted and combined at different species taxonomic levels
...
##' data(tax)
##' data(abundance)
#' COo <- COo(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group)
#' @author contact: Zhengfu Yue \email{yuezhengfu2011@163.com}
#' @export


COo <- function(kegg.category = Gene,NR.tax = tax,profile = abundance,group = group){
    d <- c("K03518","K03519","K03520")
